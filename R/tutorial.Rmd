...
they are summed. We can accommodate this situation by using the override
method. `override()` is passed the property table, the id of the target
vertex, and the result of calling `combine()`. We use a simple
pass-through combiner and perform the actual combining operation in the
override as follows:
